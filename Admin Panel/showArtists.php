...
$result = 0;
    ...
    require("../controllers/showActiveSingers.php");

    


   
    $query = findActiveSingers();
          ...
          <li class="nav-item">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="heading" style="font-size: 17px;"> <i class='bx bxs-notepad'></i></i>&nbsp;Active Singers
                    </h1>
...
if ($result && mysqli_num_rows($result) > 0) {
  ...
  Sorry there is no such recorded data within this date !
</div>
<a href='showTracks.php' style='float:right;margin:1%' class='btn btn-danger'>Search Again</a>
";
  } 
