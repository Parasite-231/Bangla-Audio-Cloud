...
$sql = "SELECT COUNT(MUSIC_INFO_ID) AS TOTAL_TRACKS FROM MUSIC_INFORMATION WHERE DELETE_FLAG = 0";
$result = mysqli_query($conn, $sql);


if ($result && mysqli_num_rows($result) > 0) {
    $data = mysqli_fetch_assoc($result);
    $total_music = $data['TOTAL_TRACKS'];
}

$sql = "SELECT COUNT(ARTIST_INFO_ID) AS TOTAL_ARTISTS FROM ARTIST_INFORMATION WHERE DELETE_FLAG = 0";
$result = mysqli_query($conn, $sql);

if ($result && mysqli_num_rows($result) > 0) {
    $data = mysqli_fetch_assoc($result);
    $total_artist = $data['TOTAL_ARTISTS'];
}
                ...
                <div class="row row-cols-1 row-cols-md-4 g-4">
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Total Tracks <img src="../icons/music2.png" height="60px"
                                        width="60px" style="float: right;" class="card-img-left" alt="..."></h5>
                                <p class="card-text"></p>
                                <p class="card-text"></p>
                                <p class="card-text" style="font-size: 30px;">&nbsp;<?php echo $total_music ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Total Artists <img src="../icons/singer.png" height="50px"
                                        width="50px" style="float: right;" class="card-img-left" alt="..."></h5>
                                <p class="card-text"></p>
                                <p class="card-text"></p>
                                <p class="card-text" style="font-size: 30px;">&nbsp;<?php echo $total_artist ?> </p>
                            </div>
                        </div>
                    </div>
